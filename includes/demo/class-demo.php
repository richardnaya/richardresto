...
if ( ! class_exists( 'Richard_Resto_Demo' ) ) {
	 ...
	 * @since 1.0.0
	 */
	class Richard_Resto_Demo {

		/**
		 * Singleton instance of Richard_Resto_Demo.
		 *
		 * @var Richard_Resto_Demo $instance Richard_Resto_Demo instance.
		 */
		...
		/**
		 * Main Richard_Resto_Demo instance.
		 *
		 * @since 1.0.0
		 *
		...
		public static function init( $config ) {
			if ( ! isset( self::$instance ) && ! ( self::$instance instanceof Richard_Resto_Demo ) ) {
				self::$instance = new Richard_Resto_Demo();
